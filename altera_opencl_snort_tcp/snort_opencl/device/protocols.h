...
#define ETH_HDR_LEN_OFFSET_WIN 	(ETH_HDR_LEN%PARSER_WIN_SIZE)
#define IPV4_HDR_LEN_OFFSET_WIN (ETH_HDR_LEN+IPV4_HDR_LEN)%PARSER_WIN_SIZE
#define TCP_HDR_LEN_OFFSET_WIN 	(ETH_HDR_LEN+IPV4_HDR_LEN+TCP_HDR_LEN)%PARSER_WIN_SIZE
